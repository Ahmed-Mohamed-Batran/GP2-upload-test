...
<head>
  ...
  <link rel="stylesheet" href="/grad-project/pages/admin/Map/css/style.css">
...
<div class="row">
    <div class="col-sm-8" id="imgDiv">
      <img id="tfloorPicDiv" src="/grad-project/pages/admin/Map/images/tuwaiqGround.png" width="700" height="500">
    </div>
    <div class="col-sm-3" style="">
      <div class="wrapper">
        <div id="tfloor3" class="tfloor"><p id="tflr3" class="flr">Tuwaiq 3</p></div>
        <div id="tfloor2" class="tfloor"><p id="tflr2" class="flr">Tuwaiq 2</p></div>
        <div id="tfloor1" class="tfloor"><p id="tflr1" class="flr">Tuwaiq 1</p></div>
        <div id="tfloor4" class="tfloor"><p id="tflr4" class="flr">Tuwaiq Ground</p></div>
      </div>
    </div>
...
<script src="/grad-project/pages/admin/Map/js/function.js" type="text/javascript"></script>
</body>
</html>