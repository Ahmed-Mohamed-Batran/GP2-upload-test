...
<div class="container">
  <div class="row">
    <div class="col-sm-8" id="imgDiv">
      <img src="/grad-project/pages/admin/Map/images/universityTop.png" width="100%" height="50%">
    </div>
    <div class="col-sm-4" style="">
      <div class="wrapper">
        <div id="inner1"><p id="main" onClick="window.location = '/grad-project/pages/admin/Map/floorPage.php'">Main Building</p></div>
        <div id="inner2"><p id="tuwaiq" onClick="window.location = '/grad-project/pages/admin/Map/tuwaiqPage.php'">Tuwaiq</p></div>
      </div>
    </div>
  </div>
</div>
